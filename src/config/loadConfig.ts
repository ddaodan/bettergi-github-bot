...
export const repoBotConfigEnvironmentVariables: EnvironmentOverrideDefinition[] = [
  ...
  environmentOverride(["issues", "subIssues", "mode"], "string"),
  environmentOverride(["issues", "subIssues", "includeParentContext"], "boolean"),
  environmentOverride(["issues", "subIssues", "parentBodyMaxChars"], "number"),
